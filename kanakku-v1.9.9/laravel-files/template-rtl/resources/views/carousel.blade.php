                ...
                <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner" role="listbox">
                        ...
                        <div class="carousel-item">
                            <img class="d-block img-fluid" src="{{ URL::asset('/assets/img/img-3.jpg')}}" alt="Second slide">
                        </div>
                        <div class="carousel-item">
            ...
            <div class="card-body">
                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner" role="listbox">
                        ...
                        <div class="carousel-item">
                            <img class="d-block img-fluid" src="{{ URL::asset('/assets/img/img-2.jpg')}}" alt="Second slide">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block img-fluid" src="{{ URL::asset('/assets/img/img-4.jpg')}}" alt="Third slide">
                        </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div id="carouselExampleCaption" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner" role="listbox">
                        <div class="carousel-item active">
                            <img src="{{ URL::asset('/assets/img/img-1.jpg')}}" alt="..." class="d-block img-fluid">
                        ...
                        <div class="carousel-item">
                            <img src="{{ URL::asset('/assets/img/img-2.jpg')}}" alt="..." class="d-block img-fluid">
                            <div class="carousel-caption d-none d-md-block">
                        ...
                        <div class="carousel-item">
                            <img src="{{ URL::asset('/assets/img/img-3.jpg')}}" alt="..." class="d-block img-fluid">
                            <div class="carousel-caption d-none d-md-block">
