						...
						<div class="row align-items-center">
							<div class="col">
								<ul class="breadcrumb invoices-breadcrumb">
									<li class="breadcrumb-item invoices-breadcrumb-item">
										<a href="{{url('invoices')}}">
											<i class="feather feather-chevron-left"></i> Back to Invoice List
										</a>
									</li>
								</ul>
							</div>
							<div class="col-auto">
								<div class="invoices-create-btn">
									<a class="invoices-preview-link" href="#" data-bs-toggle="modal" data-bs-target="#invoices_preview"><i class="feather feather-eye"></i> Preview</a>
													...
													<tbody>
														<tr class="table-form-control add-row">
															...
															<td class="add-remove text-end">
																...
																<a href="#" class="copy-btn me-2"><i class="feather feather-copy"></i></a><a href="javascript:void(0);" class="remove-btn"><i class="feather feather-trash-2"></i></a>
															</td>
														</tr>
														<tr class="table-form-control add-row">
															<td>
												...
												<div class="invoice-fields">
													...
													<div class="field-box">
														...
														<div class="payment-details">
															...
															<a href="#" data-bs-toggle="modal" data-bs-target="#delete_bank_details"><i class="feather feather-trash-2"></i></a>
														</div>
													</div>
												</div>
