...
@section('script')        
   <!-- Clipboard JS -->
	<script src="{{ URL::asset('/assets/libs/counterup/jquery.counterup.min.js')}}"></script>
    <script src="{{ URL::asset('/assets/libs/counterup/jquery.waypoints.min.js')}}"></script>
    <script src="{{ URL::asset('/assets/libs/counterup/jquery.missofis-countdown.js')}}"></script>
@endsection