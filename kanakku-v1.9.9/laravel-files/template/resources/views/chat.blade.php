						...
						<div class="chat-users-list">
							<div class="chat-scroll">
								...
								<a href="javascript:void(0);" class="media read-chat d-flex">
									<div class="media-img-wrap">
										<div class="avatar avatar-offline">
											<img src="{{ URL::asset('/assets/img/profiles/avatar-07.jpg')}}" alt="User Image" class="avatar-img rounded-circle">
										</div>
									</div>
									<div class="media-body">
										<div>
								...
								<a href="javascript:void(0);" class="media read-chat d-flex">
									<div class="media-img-wrap">
										<div class="avatar avatar-online">
											<img src="{{ URL::asset('/assets/img/profiles/avatar-11.jpg')}}" alt="User Image" class="avatar-img rounded-circle">
										</div>
									</div>
									<div class="media-body">
										<div>
								...
								<a href="javascript:void(0);" class="media read-chat d-flex">
									<div class="media-img-wrap">
										<div class="avatar avatar-away">
											<img src="{{ URL::asset('/assets/img/profiles/avatar-12.jpg')}}" alt="User Image" class="avatar-img rounded-circle">
										</div>
									</div>
									<div class="media-body">
										<div>
												...
												<div>
													<div class="chat-msg-attachments">
														<div class="chat-attachment">
															<img src="{{ URL::asset('/assets/img/img-01.jpg')}}" alt="">
