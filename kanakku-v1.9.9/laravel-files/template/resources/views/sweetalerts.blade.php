...
@section('script')  
<!-- Feather Icon JS -->
<script src="{{ URL::asset('/assets/libs/icons/sweetalert/sweetalert2.all.min.js')}}"></script>
<script src="{{ URL::asset('/assets/libs/icons/sweetalert/sweetalerts.min.js')}}"></script>
@endsection