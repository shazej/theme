...
@component('components.breadcrumb')                
    ...
    @slot('li_3') Scroll Bar @endslot
@endcomponent
@section('css')        
    <!-- Feather CSS -->
		<link rel="stylesheet" href="{{url('assets/libs/icons/scrollbar/scroll.min.css')}}">
@endsection	
    <div class="row">
...
@section('script')  
<!-- Feather Icon JS -->
<script src="{{ URL::asset('/assets/libs/icons/scrollbar/scrollbar.min.js')}}"></script>
<script src="{{ URL::asset('/assets/libs/icons/scrollbar/custom-scroll.js')}}"></script>
@endsection
