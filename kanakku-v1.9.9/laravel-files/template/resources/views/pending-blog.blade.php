...
<!-- Page Header -->
                    ...
                    <div class="row">
                        <div class="col-md-9">
                            <ul class="list-links mb-4">
                                <li><a href="{{url('blog')}}">Active Blog</a></li>
                                <li class="active"><a href="{{url('pending-blog')}}">Pending Blog</a></li>
                            </ul>
                        </div>
                        <div class="col-md-3 text-md-end">
                            <a href="{{url('add-blog')}}" class="btn btn-primary btn-blog mb-3" ><i class="feather-plus-circle me-1"></i> Add New</a>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-xl-4 col-sm-12 d-flex">
                            <div class="blog grid-blog flex-fill">
                                <div class="blog-image">
                                    <a href="{{url('blog-details')}}"><img class="img-fluid" src="{{ URL::asset('assets/img/category/blog-1.jpg')}}" alt="Post Image"></a>
                                ...
                                <div class="blog-content">
                                    <ul class="entry-meta meta-item">
                                        <li>
                                            <div class="post-author">
                                                <a href="{{url('profile')}}">
                                                    <img src="{{ URL::asset('assets/img/profiles/avatar-12.jpg')}}" alt="Post Author"> 
                                                    <span>
                                    ...
                                    <h3 class="blog-title"><a href="{{url('blog-details')}}">
                                ...
                                <div class="row">
                                    <div class="edit-options">
                                        <div class= "edit-delete-btn">
                                            <a href="{{url('edit-blog')}}" class="text-success"  ><i class="feather-edit-3 me-1"></i> Edit</a>
                        ...
                        <div class="col-md-6 col-xl-4 col-sm-12 d-flex">
                            <div class="blog grid-blog flex-fill">
                                <div class="blog-image">
                                    <a href="{{url('blog-details')}}"><img class="img-fluid" src="{{ URL::asset('assets/img/category/blog-2.jpg')}}" alt="Post Image"></a>
                                    <div class="blog-views">
                                ...
                                <div class="blog-content">
                                    <ul class="entry-meta meta-item">
                                        <li>
                                            <div class="post-author">
                                                <a href="{{url('profile')}}">
                                                    <img src="{{ URL::asset('assets/img/profiles/avatar-04.jpg')}}" alt="Post Author"> 
                                                    <span>
                                ...
                                <div class="row">
                                    <div class="edit-options">
                                        <div class= "edit-delete-btn">
                                            <a href="{{url('edit-blog')}}" class="text-success"  ><i class="feather-edit-3 me-1"></i> Edit</a>
                                            <a href="{{url('edit-blog')}}" class="text-danger" data-bs-toggle="modal" data-bs-target="#deleteModal"><i class="feather-trash-2 me-1"></i></i> Delete</a>
                                        </div>
                                        <div class="status-toggle">
                        ...
                        <div class="col-md-6 col-xl-4 col-sm-12 d-flex">    
                            <div class="blog grid-blog flex-fill">
                                <div class="blog-image">
                                    <a href="{{url('blog-details')}}"><img class="img-fluid" src="{{ URL::asset('assets/img/category/blog-3.jpg')}}" alt="Post Image"></a>
                                    <div class="blog-views">
                                ...
                                <div class="blog-content">
                                    <ul class="entry-meta meta-item">
                                        <li>
                                            <div class="post-author">
                                                <a href="{{url('profile')}}">
                                                    <img src="{{ URL::asset('assets/img/profiles/avatar-02.jpg')}}" alt="Post Author"> 
                                                    <span>
                        ...
                        <div class="col-md-6 col-xl-4 col-sm-12 d-flex">
                            <div class="blog grid-blog flex-fill">
                                <div class="blog-image">
                                    <a href="{{url('blog-details')}}"><img class="img-fluid" src="{{ URL::asset('assets/img/category/blog-4.jpg')}}" alt="Post Image"></a>
                                    <div class="blog-views">
                                ...
                                <div class="blog-content">
                                    <ul class="entry-meta meta-item">
                                        <li>
                                            <div class="post-author">
                                                <a href="{{url('profile')}}">
                                                    <img src="{{ URL::asset('assets/img/profiles/avatar-05.jpg')}}" alt="Post Author"> 
                                                    <span>
                        ...
                        <div class="col-md-6 col-xl-4 col-sm-12 d-flex">
                            <div class="blog grid-blog flex-fill">
                                <div class="blog-image">
                                    <a href="{{url('blog-details')}}"><img class="img-fluid" src="{{ URL::asset('assets/img/category/blog-5.jpg')}}" alt="Post Image"></a>
                                    <div class="blog-views">
                                ...
                                <div class="blog-content">
                                    <ul class="entry-meta meta-item">
                                        <li>
                                            <div class="post-author">
                                                <a href="{{url('profile')}}">
                                                    <img src="{{ URL::asset('assets/img/profiles/avatar-11.jpg')}}" alt="Post Author"> 
                                                    <span>
                        ...
                        <div class="col-md-6 col-xl-4 col-sm-12 d-flex">
                            <div class="blog grid-blog flex-fill">
                                <div class="blog-image">
                                    <a href="{{url('blog-details')}}"><img class="img-fluid" src="{{ URL::asset('assets/img/category/blog-6.jpg')}}" alt="Post Image"></a>
                                    <div class="blog-views">
                                ...
                                <div class="blog-content">
                                    <ul class="entry-meta meta-item">
                                        <li>
                                            <div class="post-author">
                                                <a href="{{url('profile')}}">
                                                    <img src="{{ URL::asset('assets/img/profiles/avatar-06.jpg')}}" alt="Post Author"> 
                                                    <span>
                                ...
                                <div class="row">
                                    <div class="edit-options">
                                        <div class= "edit-delete-btn">
                                            <a href="{{url('edit-blog')}}" class="text-success"  ><i class="feather-edit-3 me-1"></i> Edit</a>
                                            <a href="{{url('edit-blog')}}" class="text-danger" data-bs-toggle="modal" data-bs-target="#deleteModal"><i class="feather-trash-2 me-1"></i> Delete</a>
                                        </div>
                                        <div class="status-toggle">
                        ...
                        <div class="modal-body">
                            <div class="delete-wrap text-center">
                                ...
                                <div class="submit-section">
                                    <a href="{{url('blog')}}" class="btn btn-success me-2">Yes</a>
