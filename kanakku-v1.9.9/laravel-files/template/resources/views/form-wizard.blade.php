...
@component('components.breadcrumb')                
    ...
    @slot('li_3') Form Wizard @endslot
@endcomponent
@section('css')
    <!-- Select2 CSS -->
<link rel="stylesheet" href="{{url('assets/libs/icons/twitter-bootstrap-wizard/form-wizard.css')}}">
@endsection	
        <div class="row">
...
@section('script')        
        <!-- Select2 JS -->
		<script src="assets/libs/icons/twitter-bootstrap-wizard/jquery.bootstrap.wizard.min.js"></script>  
        <script src="assets/libs/icons/twitter-bootstrap-wizard/prettify.js"></script> 
        <script src="assets/libs/icons/twitter-bootstrap-wizard/form-wizard.js"></script>
