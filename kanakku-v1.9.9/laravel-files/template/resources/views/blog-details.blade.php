                        ...
                        <div class="col-lg-10 col-xl-9">			
                            ...
                            <div class="blog-view">
                                <div class="blog-single-post">
                                    <a href="{{url('blog')}}" class="back-btn"><i class="feather-chevron-left"></i> Back</a>
                                    <div class="blog-image">
                                        <a href="javascript:void(0);"><img alt="" src="{{ URL::asset('/assets/img/category/blog-7.jpg')}}" class="img-fluid"></a>
                                    </div>
                                            ...
                                            <ul>
                                                <li>
                                                    <div class="post-author">
                                                        <a href="{{url('profile')}}"><img src="{{ URL::asset('/assets/img/profiles/avatar-01.jpg')}}" alt="Post Author"> <span>by Prof. Lester </span></a>
                                                    </div>
                                                </li>
                                        ...
                                        <div class="about-author">
                                            <div class="about-author-img">
                                                <div class="author-img-wrap">
                                                    <a href="{{url('profile')}}"><img class="img-fluid" alt="" src="{{ URL::asset('/assets/img/profiles/avatar-10.jpg')}}"></a>
                                                </div>
                                            </div>
                                            <div class="author-details">
                                                <a href="{{url('profile')}}" class="blog-author-name">Prof. Darren Elder <span>Team Lead, Male, 40 Years Old</span></a>
                                    ...
                                    <div class="card-body pb-0">
                                        <ul class="comments-list">
                                            <li>
                                                <div class="comment">
                                                    <div class="comment-author">
                                                        <img class="avatar" alt="" src="{{ URL::asset('/assets/img/profiles/avatar-13.jpg')}}">
                                                    </div>
                                                ...
                                                <ul class="comments-list reply">
                                                    <li>
                                                        <div class="comment">
                                                            <div class="comment-author">
                                                                <img class="avatar" alt="" src="{{ URL::asset('/assets/img/profiles/avatar-06.jpg')}}">
                                                            </div>
                                                            <div class="comment-block">
                                                                <div class="comment-by">
                                                    ...
                                                    <li>
                                                        <div class="comment">
                                                            <div class="comment-author">
                                                                <img class="avatar" alt="" src="{{ URL::asset('/assets/img/profiles/avatar-05.jpg')}}">
                                                            </div>
                                                            <div class="comment-block">
                                                                <div class="comment-by">
                                            ...
                                            <li>
                                                <div class="comment">
                                                    <div class="comment-author">
                                                        <img class="avatar" alt="" src="{{ URL::asset('/assets/img/profiles/avatar-09.jpg')}}">
                                                    </div>
                                                    <div class="comment-block">
                                                        <div class="comment-by">
                                            ...
                                            <li>
                                                <div class="comment">
                                                    <div class="comment-author">
                                                        <img class="avatar" alt="" src="{{ URL::asset('/assets/img/profiles/avatar-11.jpg')}}">
                                                    </div>
                                                    <div class="comment-block">
                                                        <div class="comment-by">
