 ...
 */
 var third_party_assets = {
    ...
    mix.copy('resources/js/pages/datatable.init.js', 'public/assets/js/pages/datatable.init.js');
    mix.copy('resources/css/dataTables.bootstrap4.min.css', 'public/assets/libs/datatables');
    ...
    mix.copy('node_modules/datatables.net-bs4/css/dataTables.bootstrap4.min.css', 'public/assets/libs/datatables/datatables.min.css');
    mix.copy('node_modules/datatables.net-bs4/js/dataTables.bootstrap4.min.js', 'public/assets/libs/datatables/datatables.min.js');
    mix.copy('node_modules/datatables.net/js/jquery.dataTables.min.js', 'public/assets/libs/datatables/jquery.dataTables.min.js');
