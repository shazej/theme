				...
				<div class="sidebar-inner slimscroll"  >
					<div id="sidebar-menu" class="sidebar-menu">
						...
						<ul>
							...
							<li>
								<a href="invoices.html"><i class="fe fe-file"></i> <span>Invoices</span></a>
							</li>
							<li>
						...
						<div class="content-invoice-header">
							...
							<div class="list-btn">
								<ul class="filter-list">
									<li>
										<a class="btn btn-import me-2" href="javascript:void(0);"><span><i class="fe fe-printer me-2"></i>Print</span></a>
									</li>
									<li>
										...
										<div class="card-body">
												...
												<div class="row">
													<div class="col-md-6">
														<p class="text-start invoice-details">
															Date<span>: </span><strong>05/12/2022</strong> 
														</p>
													</div>
													<div class="col-md-6">
											...
											<div class="invoice-item invoice-item-two">
												<div class="row">
													<div class="col-md-6">
														<div class="invoice-info">
															<strong class="customer-text-one">Credit To<span>:</span></strong>
