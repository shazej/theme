...
const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'tax-rats', loadChildren: () => import('./tax-rats/tax-rats.module').then(m => m.TaxRatsModule) },
      { path: 'email-settings', loadChildren: () => import('./email-settings/email-settings.module').then(m => m.EmailSettingsModule) },
      { path: 'template-invoice', loadChildren: () => import('./template-invoice/template-invoice.module').then(m => m.TemplateInvoiceModule) },
    ],
  },
