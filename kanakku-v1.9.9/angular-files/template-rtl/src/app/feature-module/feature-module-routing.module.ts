...
const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'quotationspage', loadChildren: () => import('./quotationspage/quotationspage.module').then(m => m.QuotationspageModule) },
      { path: 'payment-summary', loadChildren: () => import('./payment-summary/payment-summary.module').then(m => m.PaymentSummaryModule) },
      { path: 'add-delivery-challans', loadChildren: () => import('./add-delivery-challans/add-delivery-challans.module').then(m => m.AddDeliveryChallansModule) },
      { path: 'edit-delivery-challans', loadChildren: () => import('./edit-delivery-challans/edit-delivery-challans.module').then(m => m.EditDeliveryChallansModule) },
      { path: 'permission', loadChildren: () => import('./permission/permission.module').then(m => m.PermissionModule) },
      
      
     
      
      { path: 'edit-faq', loadChildren: () => import('./edit-faq/edit-faq.module').then(m => m.EditFaqModule) },
      { path: 'contact-details', loadChildren: () => import('./contact-details/contact-details.module').then(m => m.ContactDetailsModule) },
      { path: 'signature-list', loadChildren: () => import('./signature-list/signature-list.module').then(m => m.SignatureListModule) },
      { path: 'pay-online', loadChildren: () => import('./pay-online/pay-online.module').then(m => m.PayOnlineModule) },
      { path: 'notifications', loadChildren: () => import('./notifications/notifications.module').then(m => m.NotificationsModule) },
      { path: 'mail-pay-invoice', loadChildren: () => import('./mail-pay-invoice/mail-pay-invoice.module').then(m => m.MailPayInvoiceModule) },
