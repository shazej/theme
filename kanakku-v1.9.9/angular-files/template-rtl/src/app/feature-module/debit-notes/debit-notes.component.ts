...
import { apiResultFormat, debitnotes, pageSelection } from 'src/app/core/models/models';
...
export class DebitNotesComponent implements OnInit {
  ...
  public purchase: Array<debitnotes> = [];
  isCollapsed = false;
  ...
  private getTableData(): void {
    ...
    this.data.getdebitnotes().subscribe((data: apiResultFormat) => {
      this.totalData = data.totalData;
      data.data.map((res: debitnotes, index: number) => {
      ...
      this.dataSource = new MatTableDataSource<debitnotes>(this.purchase);
