...
import { apiResultFormat, pageSelection, subscribers } from 'src/app/core/models/models';
...
export class SubscribersComponent implements OnInit{
  ...
  private getTableData(): void {
    ...
    this.data.getSubscribers().subscribe((data: apiResultFormat) => {
      this.totalData = data.totalData;
      data.data.map((res: subscribers, index: number) => {
