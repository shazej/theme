...
import { apiResultFormat, pageSelection, transaction } from 'src/app/core/models/models';
...
export class TransactionsComponent implements OnInit {
  ...
  private getTableData(): void {
    ...
    this.data.getTransaction().subscribe((data: apiResultFormat) => {
      this.totalData = data.totalData;
      data.data.map((res: transaction, index: number) => {
