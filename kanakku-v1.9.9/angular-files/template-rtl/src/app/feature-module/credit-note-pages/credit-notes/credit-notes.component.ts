...
export class CreditNotesComponent implements OnInit {
  ...
  private getTableData(): void {
    ...
    this.data.getcreditnotes().subscribe((data: apiResultFormat) => {
      this.totalData = data.totalData;
      data.data.map((res: creditnotes, index: number) => {
      ...
      this.dataSource = new MatTableDataSource<creditnotes>(this.creditnotes);
