...
import { apiResultFormat, pageSelection, quote } from 'src/app/core/models/models';
...
export class QuotationsComponent implements OnInit {
  ...
  private getTableData(): void {
    ...
    this.data.getquotation().subscribe((data: apiResultFormat) => {
      this.totalData = data.totalData;
      data.data.map((res: quote, index: number) => {
