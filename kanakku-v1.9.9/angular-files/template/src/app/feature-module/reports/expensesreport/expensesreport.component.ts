...
import { apiResultFormat, expense, pageSelection } from 'src/app/core/models/models';

@Component({
  selector: 'app-expensesreport',
  templateUrl: './expensesreport.component.html',
  styleUrls: ['./expensesreport.component.scss'],
})
export class ExpensesreportComponent implements OnInit {
  ...
  private getTableData(): void {
    ...
    this.data.getExpensesList().subscribe((data: apiResultFormat) => {
      this.totalData = data.totalData;
      data.data.map((res: expense, index: number) => {
