...
import { apiResultFormat, pageSelection, role } from 'src/app/core/models/models';
...
export class RolesPermissionComponent implements OnInit {
  ...
  private getTableData(): void {
    ...
    this.data.getrole().subscribe((data: apiResultFormat) => {
      this.totalData = data.totalData;
      data.data.map((res: role, index: number) => {
  ...
  public searchData(value: any): void {
    ...
    this.roles = this.dataSource.filteredData;
  }
