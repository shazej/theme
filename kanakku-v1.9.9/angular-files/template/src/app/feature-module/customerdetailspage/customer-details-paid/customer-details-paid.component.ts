...
import { apiResultFormat, pageSelection, recurringinvoice } from 'src/app/core/models/models';

@Component({
  selector: 'app-customer-details-paid',
  templateUrl: './customer-details-paid.component.html',
  styleUrls: ['./customer-details-paid.component.scss']
})
export class CustomerDetailsPaidComponent implements OnInit {
  ...
  private getTableData(): void {
    ...
    this.data.recurringinvoice().subscribe((data: apiResultFormat) => {
      ...
      this.dataSource = new MatTableDataSource<recurringinvoice>(this.recurringinvoice);
