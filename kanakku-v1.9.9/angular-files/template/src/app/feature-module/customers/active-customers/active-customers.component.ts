...
import { activecustomer, apiResultFormat, pageSelection } from 'src/app/core/models/models';
...
export class ActiveCustomersComponent implements OnInit {
  public customers: Array<activecustomer> = [];
  ...
  private getTableData(): void {
    ...
    this.data.getActive().subscribe((data: apiResultFormat) => {
      this.totalData = data.totalData;
      data.data.map((res: activecustomer, index: number) => {
      ...
      this.dataSource = new MatTableDataSource<activecustomer>(this.customers);
