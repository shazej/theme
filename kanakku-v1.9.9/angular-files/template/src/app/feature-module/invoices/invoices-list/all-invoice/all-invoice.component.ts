...
import { apiResultFormat, invoice, pageSelection } from 'src/app/core/models/models';
...
export class AllInvoiceComponent implements OnInit {
  ...
  private getTableData(): void {
    ...
    this.data.getinvoice().subscribe((data: apiResultFormat) => {
      this.totalData = data.totalData;
      data.data.map((res: invoice, index: number) => {
      ...
      this.dataSource = new MatTableDataSource<invoice>(this.invoice);
