...
export class InvoicesOverdueComponent implements OnInit {
  public invoice: Array<invoiceoverdue> = [];
  ...
  private getTableData(): void {
    ...
    this.data.getinvoiceoverdue().subscribe((data: apiResultFormat) => {
      ...
      this.dataSource = new MatTableDataSource<invoiceoverdue>(this.invoice);
