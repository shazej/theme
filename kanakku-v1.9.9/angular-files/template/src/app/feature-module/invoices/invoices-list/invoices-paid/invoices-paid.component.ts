...
import { apiResultFormat, invoicepaid, pageSelection } from 'src/app/core/models/models';
...
export class InvoicesPaidComponent implements OnInit {
  public invoice: Array<invoicepaid> = [];
  ...
  private getTableData(): void {
    ...
    this.data.getinvoicepaid().subscribe((data: apiResultFormat) => {
      this.totalData = data.totalData;
      data.data.map((res: invoicepaid, index: number) => {
      ...
      this.dataSource = new MatTableDataSource<invoicepaid>(this.invoice);
