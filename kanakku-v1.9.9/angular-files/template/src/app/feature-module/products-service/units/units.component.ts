...
import { apiResultFormat, pageSelection, units } from 'src/app/core/models/models';
...
export class UnitsComponent implements OnInit {
  ...
  private getTableData(): void {
    ...
    this.data.getUnits().subscribe((data: apiResultFormat) => {
      this.totalData = data.totalData;
      data.data.map((res: units, index: number) => {
