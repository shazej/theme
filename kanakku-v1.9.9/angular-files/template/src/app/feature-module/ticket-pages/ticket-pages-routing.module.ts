...
const routes: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadChildren: () =>
          import('./tickets-list-cancelled/tickets-list-cancelled.module').then(
            (m) => m.TicketsListCancelledModule
          ),
      },
      {
      ...
      },
      {
        path: 'tickets-draft',
        loadChildren: () =>
          import('./tickets-draft/tickets-draft.module').then(
            (m) => m.TicketsDraftModule
          ),
      },
      {
      ...
      },
      {
        ...
        loadChildren: () =>
          import('./tickets-cancelled/tickets-cancelled.module').then(
            (m) => m.TicketsCancelledModule
          ),
      },
      {
