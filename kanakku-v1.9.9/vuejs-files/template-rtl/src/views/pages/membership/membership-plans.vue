          ...
          <div class="content-page-header">
            ...
            <div class="list-btn">
              <ul class="filter-list">
                <li>
                  <router-link class="btn btn-primary" to="add-membership"
                ...
                <div class="card-body">
                  ...
                  <div class="plan-button">
                    <a
                      ...
                      href="javascript:;"
                      >Get Started<span class="ms-2"
                        ><i class="feather feather-arrow-right"></i></span
                    ></a>
                  </div>
                </div>
              </div>
              ...
              <div class="card price-selected">
                <div class="card-body plan-header-selected">
                  ...
                  <div class="plan-description">
                    ...
                    <ul>
                      <li>
                        <span class="rounded-circle bg-white me-2"
                          ><i class="text-primary feather feather-check"></i
                        ></span>
                        All analytics features
                      </li>
                      <li>
