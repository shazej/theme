                        ...
                        <div class="col-lg-10 col-xl-9">			
                            ...
                            <div class="blog-view">
                                <div class="blog-single-post">
                                    <router-link to="/blog" class="back-btn"><i class="feather-chevron-left"></i> Back</router-link>
                                            ...
                                            <ul>
                                                <li>
                                                    <div class="post-author">
                                                        <router-link to="/profile"><img src="../../assets/img/profiles/avatar-01.jpg" alt="Post Author"> <span>by Prof. Lester </span></router-link>
                                                    </div>
                                                </li>
                                        ...
                                        <div class="about-author">
                                            <div class="about-author-img">
                                                <div class="author-img-wrap">
                                                    <router-link to="/profile"><img class="img-fluid" alt="" src="../../assets/img/profiles/avatar-10.jpg"></router-link>
                                                </div>
                                            </div>
                                            <div class="author-details">
                                                <router-link to="/profile" class="blog-author-name">Prof. Darren Elder <span>Team Lead, Male, 40 Years Old</span></router-link>
                                ...
                                <div class="card blog-share clearfix">
                                    ...
                                    <div class="card-body">
                                        <ul class="social-share">
                                            <li><a href="javascript:;"><i class="feather-twitter"></i></a></li>
                                            <li><a href="javascript:;"><i class="feather-facebook"></i></a></li>
                                            <li><a href="javascript:;"><i class="feather-linkedin"></i></a></li>
                                            <li><a href="javascript:;"><i class="feather-instagram"></i></a></li>
                                            <li><a href="javascript:;"><i class="feather-youtube"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
