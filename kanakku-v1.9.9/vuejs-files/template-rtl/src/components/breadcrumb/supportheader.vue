  ...
  mounted() {
    ...
    if (document.querySelectorAll(".viewall-One").length > 0) {
      document.addEventListener("DOMContentLoaded", function () {
        document.querySelector(".viewall-One").style.display = "none";
        document
          .querySelector(".viewall-button-One")
          .addEventListener("click", function () {
            this.textContent =
              this.textContent === "Close All" ? "View All" : "Close All";
            document.querySelector(".viewall-One").classList.toggle("slideToggle");
          });
      });
    }
    ...
    if (document.querySelectorAll(".viewall-Two").length > 0) {
      document.addEventListener("DOMContentLoaded", function () {
        document.querySelector(".viewall-Two").style.display = "none";
        document
          .querySelector(".viewall-button-Two")
          .addEventListener("click", function () {
            this.textContent =
              this.textContent === "Close All" ? "View All" : "Close All";
            document.querySelector(".viewall-Two").classList.toggle("slideToggle");
          });
      });
    }
  },
