    ...
    <div class="profile-cover-wrap">
      ...
      <div class="cover-content">
        <div class="custom-file-btn">
          <input type="file" class="custom-file-btn-input" id="" />
          <label class="custom-file-btn-label btn btn-sm btn-white" for="cover_upload">
            <i class="fas fa-camera"></i>
            <span class="d-none d-sm-inline-block ms-2">Update Covecover_uploadr</span>
          </label>
        </div>
      </div>
      <!-- /Custom File Cover -->
...
export default {
  mounted() {
    ...
    if (coverImage) {
      ...
      const coverUpload = document.querySelector("#cover_upload");
      if (coverUpload) {
