                ...
                <div className="card-body card-support">
                  <div className="comments-details d-flex align-items-center justify-content-between">
                    <div className="d-flex align-items-center describe-btn mt-0">
                      ...
                      <span className="badge badge-pill bg-success-light me-3">
                        Paid
                      </span>
                    </div>
                    <Link
                    ...
                    >
                      <span>
                        <i className="fe fe-clock text-gray-light fw-normal ms-2">
                ...
                <div className="card-body card-support">
                  <div className="comments-details d-flex align-items-center justify-content-between">
                    <div className="d-flex align-items-center describe-btn mt-0">
                      ...
                      <span className="badge bg-primary-light me-3">
                        Overdue
                      </span>
                    </div>
                    <Link
                ...
                <div className="card-body card-support">
                  <div className="comments-details d-flex align-items-center justify-content-between">
                    <div className="d-flex align-items-center describe-btn mt-0">
                      ...
                      <span className="badge bg-warning-light text-warning-light me-3">
                        Pending
                      </span>
                    </div>
                    <Link
                ...
                <div className="card-body card-support">
                  <div className="comments-details d-flex align-items-center justify-content-between">
                    <div className="d-flex align-items-center describe-btn mt-0">
                      ...
                      <span className="badge bg-danger-light text-danger-light me-3">
                        Cancelled
                      </span>
                    </div>
                    <Link
