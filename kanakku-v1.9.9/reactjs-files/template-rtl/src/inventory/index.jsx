    ...
    },
    {
      ...
      render: (text, record) => (
        <div className="d-flex align-items-center">
          <Link
            to="#"
            className="btn btn-greys bg-success-light ms-2"
            data-bs-toggle="modal"
            data-bs-target="#stock_in"
          >
            <i className="fa fa-plus-circle ms-1" /> Stock in
          </Link>
          <Link
            to="#"
            className="btn btn-greys bg-danger-light ms-2"
            data-bs-toggle="modal"
            data-bs-target="#stock_out"
          >
            <i className="fa fa-plus-circle ms-1" /> Stock out
          </Link>
              ...
              <div className="content-page-header ">
                ...
                <div className="list-btn">
                  <ul className="filter-list">
                    ...
                    <li>
                      <Link
                        className="active btn-filters ms-2"
                        to="#"
                      >
                        <span>
