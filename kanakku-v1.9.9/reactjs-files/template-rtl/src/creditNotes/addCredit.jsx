            ...
            <div className="col-md-12">
              <div className="card">
                <div className="card-body">
                    ...
                    <div className="row align-item-center">
                      ...
                      <div className="col-lg-4 col-md-6 col-sm-12">
                        <div className="form-group">
                          ...
                          <div className="mt-2">
                            <label className="custom_check ms-3 mb-0">
                  ...
                  <div className="form-group-item add-credit">
                        ...
                        <div className="form-group-bank">
                          ...
                          <div className="form-group mb-0">
                            ...
                            <div className="form-group service-upload service-upload-info mb-0">
                              <span>
                                <i className="fe fe-upload-cloud ms-1" />
                                Upload Signature
                              </span>
                  ...
                  <div className="add-customer-btns text-end">
                    ...
                    <button type="submit" className="btn customer-btn-save me-2">
                      Save Changes
                    </button>
                  </div>
                </div>
