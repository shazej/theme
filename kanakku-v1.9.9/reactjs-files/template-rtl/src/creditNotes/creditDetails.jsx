              ...
              <div className="content-invoice-header">
                ...
                <div className="list-btn">
                  <ul className="filter-list">
                    <li>
                      <Link
                        className="btn btn-import ms-2"
                        to="#"
                      >
                        <span>
                          {/* <i className="fe fe-printer ms-2" /> */}
                          <FeatherIcon icon="printer" className="ms-2"/>
                          Print
                        </span>
                      </Link>
                    </li>
                    <li>
                      <Link to="#" className="btn btn-primary" download="">
                        <i className="fa fa-download ms-2" aria-hidden="true" />
                        Download
                      </Link>
                    </li>
                  </ul>
                          ...
                          <div className="row align-items-center justify-content-between">
                            <div className="col-lg-6 col-md-6">
                              <div className="invoice-terms align-center">
                                <span className="invoice-terms-icon bg-white-smoke ms-3">
