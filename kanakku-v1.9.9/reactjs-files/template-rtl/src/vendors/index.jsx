      ...
      render: (text, record) => (
        <>
          <h2 className="table-avatar">
            <Link to="/profile" className="avatar avatar-md ms-2">
              <img
      ...
      render: (text, record) => (
        <>
          <div className="d-flex align-items-center">
            <Link to="/add-ledger" className="btn btn-greys ms-2">
              <i className="fa fa-eye ms-1" /> Ledger
            </Link>
                  ...
                  <ul className="filter-list">
                    ...
                    <li>
                      <Link className="btn btn-import" to="#">
                        <span>
                          <FeatherIcon icon="check-square" className="ms-2" />{" "}
                          Import
                        </span>
                      </Link>
                    </li>
