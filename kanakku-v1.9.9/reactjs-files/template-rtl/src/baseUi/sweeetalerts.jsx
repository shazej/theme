            ...
            <div className="col-md-12">
              ...
              <div className="card">
                ...
                <div className="card-body card-buttons">
                  ...
                  <button
                    type="button"
                    className="btn btn-outline-primary mr-1 mb-1 ms-1"
                    id="basic-alert"
                  >
                    Basic
                  </button>
              ...
              <div className="card">
                ...
                <div className="card-body card-buttons">
                  ...
                  <button
                    className="btn btn-outline-success mr-1 mb-1 ms-1"
              ...
              <div className="card">
                ...
                <div className="card-body card-buttons">
                  ...
                  <button
                    type="button"
                    className="btn btn-outline-info mr-1 mb-1 ms-1"
                    id="type-info"
                  >
                    Info
                  </button>
                  <button
                    type="button"
                    className="btn btn-outline-warning mr-1 mb-1 ms-1"
                    id="type-warning"
                  >
                    Warning
                  </button>
