<?php
 ...
 ?>
   ...
   <link rel="stylesheet" href="<?php echo base_url();?>/assets/css/ckeditor.css">
	...
	<?php } if ($page == 'invoices' || $page == 'edit_invoice' || $page == 'view_invoice' || $page == 'view_estimate' || $page == 'add_estimate' || $page == 'invoice_grid' || $page == 'invoice_paid' || $page == 'invoice_overdue' || $page == 'invoice_draft' || $page == 'invoice_recurring' || $page == 'invoice_cancelled' || $page == 'invoices_settings' || $page == 'tax_settings' || $page == 'bank_settings' || $page == 'add_invoice' || $page == 'invoice_item' || $page == 'invoice_category' || $page == 'payments' || $page == 'add_payments' || $page == 'expenses' || $page == 'add_expenses' || $page == 'edit_expenses' || $page == 'sales_report' || $page == 'expenses_report' || $page == 'profit_loss_report' || $page == 'taxs_report' || $page == 'calendar') { ?>
