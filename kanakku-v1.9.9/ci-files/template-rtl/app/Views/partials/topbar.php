                                ...
                                <ul class="notification-list">
                                        ...
                                        <a href="#">
                                            <div class="media d-flex">
                                                <span class="avatar avatar-sm">
                                                    <img class="avatar-img rounded-circle" alt="" src="<?php echo base_url();?>/assets/img/profiles/avatar-02.jpg">
                                                </span>
                                    ...
                                    <li class="notification-message">
                                        <a href="#">
                                            <div class="media d-flex">
                                                <span class="avatar avatar-sm">
                                                    <img class="avatar-img rounded-circle" alt="" src="<?php echo base_url();?>/assets/img/profiles/avatar-03.jpg">
                                                </span>
                                                <div class="media-body">
                                    ...
                                    <li class="notification-message">
                                        <a href="#">
                                            <div class="media d-flex">
                                                <span class="avatar avatar-sm">
                                                    <img class="avatar-img rounded-circle" alt="" src="<?php echo base_url();?>/assets/img/profiles/avatar-04.jpg">
                                                </span>
                                                <div class="media-body">
