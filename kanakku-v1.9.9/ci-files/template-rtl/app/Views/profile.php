                        ...
                        <div class="col-lg-10">
                            ...
                            <div class="profile-cover">
                                <div class="profile-cover-wrap">
                                    <img class="profile-cover-img" src="<?php echo base_url();?>/assets/img/profiles/avatar-02.jpg" alt="Profile Cover">
                            ...
                            <div class="text-center mb-5">
                                <label class="avatar avatar-xxl profile-cover-avatar" for="avatar_upload">
                                    <img class="avatar-img" src="<?php echo base_url();?>/assets/img/profiles/avatar-02.jpg" alt="Profile Image">
                                        ...
                                        <div class="card-body card-body-height">
                                            <ul class="activity-feed">
                                                <li class="feed-item">
                                                    ...
                                                    <span class="feed-text"><a href="profile">Brian Johnson</a> has paid the invoice <a href="view_invoice">"#DF65485"</a></span>
                                                </li>
                                                <li class="feed-item">
                                                    <div class="feed-date">Nov 7</div>
                                                    <span class="feed-text"><a href="profile">Marie Canales</a>  has accepted your estimate <a href="view_estimate">#GTR458789</a></span>
                                                </li>
                                                <li class="feed-item">
                                                ...
                                                <li class="feed-item">
                                                    ...
                                                    <span class="feed-text"><a href="profile">Robert Martin</a> gave a review for <a href="product_details">"Dell Laptop"</a></span>
                                                </li>
                                                <li class="feed-item">
