                    ...
                    <div class="row">
                        <div class="col-md-9">
                            <ul class="list-links mb-4">
                                <li class="active"><a href="blogs">Active Blog</a></li>
                                <li><a href="pending_blog">Pending Blog</a></li>
                            </ul>
                        </div>
                                ...
                                <div class="row">
                                    <div class="edit-options">
                                        <div class= "edit-delete-btn">
                                            <a href="edit_blog" class="text-success"  ><i data-feather="edit-3" class="me-1"></i> Edit</a>
                                        ...
                                        <div class="text-end inactive-style">
                                            <a href="javascript:void(0);" class="text-danger" data-bs-toggle="modal" data-bs-target="#deleteNotConfirmModal"><i data-feather="eye-off" class="me-1"></i> Inactive</a>
                                        </div>
                                    </div>
                                </div>
                            </div>                                      
                            ...
                            <div class="blog grid-blog flex-fill">
                                ...
                                <div class="row">
                                    <div class="edit-options">
                                        <div class= "edit-delete-btn">
                                            <a href="edit_blog" class="text-success"  ><i data-feather="edit-3" class="me-1"></i> Edit</a>
                                            <a href="edit_blog" class="text-danger" data-bs-toggle="modal" data-bs-target="#deleteModal"><i data-feather="trash-2" class="me-1"></i></i> Delete</a>
                                        </div>
                                        <div class="text-end inactive-style">
                                            <a href="javascript:void(0);" class="text-danger" data-bs-toggle="modal" data-bs-target="#deleteNotConfirmModal"><i data-feather="eye-off" class="me-1"></i> Inactive</a>
                                        </div>
