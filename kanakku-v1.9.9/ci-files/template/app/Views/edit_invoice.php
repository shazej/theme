                                                ...
                                                <div class="col-xl-5 col-md-6 col-sm-12 col-12">
                                                    ...
                                                    <div class="invoice-details-box">
                                                        <div class="invoice-inner-head">
                                                            <span>Invoice No. <a href="view_invoice">IN093439#@09</a></span>
                                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-xl-4 col-lg-6 col-md-6">
                                                    <div class="invoice-info">
                                                        <strong class="customer-text">Invoice From <a class="small" href="edit_invoice">Edit Address</a></strong>
                                        ...
                                        <div class="card-body pb-0">
                                            ...
                                            <div class="invoice-item invoice-item-bg">
                                                <div class="invoice-circle-img">
                                                    <img src="<?php echo base_url();?>/assets/img/invoice-circle1.png" alt="" class="invoice-circle1">
                                                    <img src="<?php echo base_url();?>/assets/img/invoice-circle2.png" alt="" class="invoice-circle2">
                                                </div>
                                                <div class="row">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-4 col-md-4">
                                                        <div class="invoice-sign text-end">
                                                            <img class="img-fluid d-inline-block" src="<?php echo base_url();?>/assets/img/signature.png" alt="sign">
