                                ...
                                <div class="row align-items-center">
                                    <div class="col-lg-12 col-md-12">
                                        <div class="invoices-items-tabs">
                                            <ul>
                                                <li><a href="invoice_item">All Items</a></li>
                                                <li><a href="invoice_category" class="active">Category</a></li>    
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        ...
                                                        <a href="#" class="invoice-link">GoMechanic Neutron 600...</a>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <a href="#" class="invoice-link">Car Wash Shampoo 250ml...</a>
                                                    </td>
                                                    <td class="items-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</td>
                                                    <td>14 Mar 2022</td>
                                                    <td class="text-end">
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <a href="#" class="invoice-link">Bosch 1300W High Pressure...</a>
                                                    </td>
                                                    <td class="items-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</td>
                                                    <td>7 Mar 2022</td>
                                                    <td class="text-end">
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <a href="#" class="invoice-link">Clear Coat Spray -Quick Dr...9</a>
                                                    </td>
                                                    <td class="items-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</td>
                                                    <td>24 Mar 2022</td>
                                                    <td class="text-end">
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <a href="#" class="invoice-link">Aquatak High Pressure Wash.</a>
                                                    </td>
                                                    <td class="items-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</td>
                                                    <td>17 Mar 2022</td>
                                                    <td class="text-end">
